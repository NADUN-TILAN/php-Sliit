  ...
  <footer class="page-footer">
      ...
      <div class="container clearfix">
        ...
        <div class="footer-nav__col footer-nav__col--contacts">
          ...
          <address class="address">
            Head Office: Nadun Fashion.<br>
            180-182 Colombo 05, Srilanka.
          </address>
          <div class="phone">
            Telephone:
            <a class="phone__number" href="tel:0761996602">0761-996-602</a>
          </div>
          <div class="email">
            Email:
            <a href="mailto:tilannadun@gmail.com" class="email__addr">tilannadun@gmail.com</a>
          </div>
        </div>
    ...
    <div class="page-footer__subline">
      <div class="container clearfix">
        ...
        <div class="copyright">
          &copy; <?php echo date("Y"); ?> NADUN Website-PHP&trade;
        </div>

        <div class="developer">
          Developed by Nadun Code
        </div>
